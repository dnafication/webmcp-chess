    ...
    >
      <body className="min-h-full flex flex-col">
        <a
          ...
          className="fixed right-4 top-4 z-50 flex h-9 w-9 items-center justify-center rounded-full border border-black/10 bg-white/90 text-zinc-700 shadow-sm backdrop-blur transition-colors hover:bg-white hover:text-zinc-950 dark:border-white/10 dark:bg-zinc-900/90 dark:text-zinc-300 dark:hover:bg-zinc-900 dark:hover:text-zinc-50"
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
